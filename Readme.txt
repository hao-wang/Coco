...
Notes:
0 The code is tested in IDL 7.1;  
...
1) cd into coco:
	Edit coco.f90£¬that is, set the value of use_MCMC;	
	Edit readdata.f90, add data set or comment out some data;
	Edit io.f90, set desired plotdir;
	Edit settings.f90£¬set the model and its parameters. You might need to read carefully of this file: I tried my best to put everything that does not need to be changed out of this file;
	make
